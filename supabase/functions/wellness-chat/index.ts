...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are Serene, a compassionate and supportive AI wellness companion. Your purpose is to help users with:
...
- Gentle motivation for self-care
...
- Remember you're here to support their wellness journey`;
